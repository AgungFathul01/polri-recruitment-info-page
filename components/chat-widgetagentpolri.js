...
(function() {
    ...
    const chatInterfaceHTML = `
        <div class="chat-interface">
            ...
            <div class="chat-input">
                <textarea placeholder="ketik chatmu disini..." rows="1"></textarea>
    ...
    document.addEventListener('click', (e) => {
        const isClickInsideWidget = chatContainer.contains(e.target);
        const isClickOnToggle = toggleButton.contains(e.target);
        
        if (chatContainer.classList.contains('open') && !isClickInsideWidget && !isClickOnToggle) {
            chatContainer.classList.remove('open');
        }
    });
})();